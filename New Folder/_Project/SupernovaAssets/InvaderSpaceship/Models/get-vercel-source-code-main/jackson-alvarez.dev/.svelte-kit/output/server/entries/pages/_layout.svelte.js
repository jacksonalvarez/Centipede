import { g as get_store_value, c as create_ssr_component, e as escape, a as add_attribute, b as compute_slots, d as add_styles, v as validate_component } from "../../chunks/ssr.js";
  ...
  return ` ${validate_component(AppShell, "AppShell").$$render($$result, {}, {}, {
    header: () => {
      return ` ${validate_component(AppBar, "AppBar").$$render($$result, {}, {}, {
        trail: () => {
          return `<a class="btn btn-sm variant-ghost-surface" href="/" rel="noreferrer" data-svelte-h="svelte-1kt6arl">Home 🏠</a> <a class="btn btn-sm variant-ghost-surface" href="/Work" rel="noreferrer" data-svelte-h="svelte-1gscd83">Work 💼</a> <a class="btn btn-sm variant-ghost-surface" href="/Blog" rel="noreferrer" data-svelte-h="svelte-werc1m">Blog 📚</a> `;
        },
        lead: () => {
          return `<strong class="text-xl uppercase" data-svelte-h="svelte-1ur0063">jackson-alvarez.dev</strong>`;
        }
      })} `;
    },
    default: () => {
