	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord18 = input.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
...
ASEEND*/
//CHKSM=D309A564F0EA6C626F5F4C7B7D8209BD7CB16CFB